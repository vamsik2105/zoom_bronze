...
-- Data Quality Errors Table - Foundation table for capturing validation errors
WITH error_base AS (
  SELECT 
    ...
    'Initial setup - no errors' as error_description,
    'N/A' as error_value,
...
WHERE FALSE -- This ensures no initial record is created unless there are actual errors
