...
SELECT 
    ...
    CASE WHEN pb.user_id = mh.host_id THEN 'Host' ELSE 'Participant' END as participant_role,
...
LEFT JOIN feature_usage_by_participant fup ON pb.meeting_id = fup.meeting_id AND pb.participant_id = fup.participant_id
